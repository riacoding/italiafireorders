export default function HomePage() {
  return (
    <main className='min-h-screen bg-white text-gray-800'>
      <section className='px-6 py-20 text-center bg-orange-50'>
        ...
        <p className='text-md sm:text-lg text-gray-700 max-w-2xl mx-auto mb-10'>
        ...
        <div className='mb-12'>
          ...
          <p className='text-grey-800 font-semibold text-sm'>(It's in the name)</p>
        </div>
        ...
        <div className='max-w-4xl mx-auto grid gap-8 sm:grid-cols-2'>
          <div>
            <h2 className='text-2xl font-semibold mb-2 flex items-center gap-2'>
              <img src='/forkclock.png' alt='icon' className='w-6 h-6' /> Easy Setup
            </h2>
            <p>Start taking online orders and notifying customers in minutes — no tech skills needed.</p>
          </div>
          <div>
            <h2 className='text-2xl font-semibold mb-2 flex items-center gap-2'>
          ...
          <div>
            <h2 className='text-2xl font-semibold mb-2 flex items-center gap-2'>
              <img src='/forkclock.png' alt='icon' className='w-6 h-6' /> No Per-Transaction Fees
            </h2>
            <p>We don’t take a cut of your orders. Your revenue stays yours.</p>
          </div>
          <div>
            <h2 className='text-2xl font-semibold mb-2 flex items-center gap-2'>
              <img src='/forkclock.png' alt='icon' className='w-6 h-6' /> Kitchen Display Anywhere
            </h2>
            <p>Access your KDS from any phone, tablet, or screen — built for mobile operations.</p>
          </div>
        </div>
      </section>
